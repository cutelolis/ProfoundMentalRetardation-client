...
public final class AutismModuleViewOverlay extends AutismOverlayBase {
    ...
    public AutismModuleViewOverlay(Font font) {
        super("autism-module-view", 220, 200);
        this.font = font;
        this.panelX = 130;
        this.panelY = 48;
    }
    ...
    public boolean open(MmMessages.BlobOffer blob) {
        ...
        if (mv == null) { AutismNotifications.show("Could not read shared module settings.", 0xFFFF5B5B); return false; }
